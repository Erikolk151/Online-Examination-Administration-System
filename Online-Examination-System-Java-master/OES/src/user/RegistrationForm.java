...
public class RegistrationForm extends JPanel implements ActionListener {
	...
	public boolean checkData()
	{
		...
		else if(UNIVERSITY.getText().equals(""))
		{
	...
	public RegistrationForm() {
		...
		submit.setBounds(477, 470, 155, 35);
		add(submit);
		...
		reset.setBounds(295, 470, 145, 35);
		add(reset);
		...
		UNIVERSITY.setFont(new Font("Tahoma", Font.BOLD, 14));
		UNIVERSITY.setColumns(10);
		UNIVERSITY.setBounds(276, 305, 331, 20);
		add(UNIVERSITY);
		
		JLabel lblCollege = new JLabel("UNIVERSITY");
...
//		add(lblName);
	...
	public RegistrationForm(EditDetails e) {
		...
		UNIVERSITY = new JTextField(e.UNIVERSITY);
		UNIVERSITY.setFont(new Font("Tahoma", Font.BOLD, 14));
		UNIVERSITY.setColumns(10);
		UNIVERSITY.setBounds(277, 324, 331, 20);
		add(UNIVERSITY);
